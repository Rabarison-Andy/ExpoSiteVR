...
var Mesh = class extends Object3D {
  ...
  raycast(raycaster, intersects) {
    ...
    if (_sphere2.containsPoint(_ray.origin) === false) {
      if (_ray.intersectSphere(_sphere2, _sphereHitAt) === null)
        return;
...
function WebGLTextures(_gl, extensions, state, properties, capabilities, utils, info) {
  ...
  function uploadTexture(textureProperties, texture, slot) {
    ...
    if (source.version !== sourceProperties.__version || forceUpload === true) {
      ...
      const supportsMips = isPowerOfTwo2(image) || isWebGL2, glFormat = utils.convert(texture.format, texture.colorSpace);
  ...
  function uploadCubeTexture(textureProperties, texture, slot) {
    ...
    if (source.version !== sourceProperties.__version || forceUpload === true) {
      ...
      const image = cubeImage[0], supportsMips = isPowerOfTwo2(image) || isWebGL2, glFormat = utils.convert(texture.format, texture.colorSpace), glType = utils.convert(texture.type), glInternalFormat = getInternalFormat(texture.internalFormat, glFormat, glType, texture.colorSpace);
...
var WebGLRenderer = class {
  constructor(parameters = {}) {
        ...
        if (object.isGroup) {
          ...
          if (!object.frustumCulled || _frustum.intersectsObject(object)) {
            ...
            if (sortObjects) {
              ...
              _vector32.applyMatrix4(object.matrixWorld).applyMatrix4(_projScreenMatrix);
            }
            if (Array.isArray(material)) {
              const groups = geometry.groups;
              for (let i = 0, l = groups.length; i < l; i++) {
    ...
    function renderTransmissionPass(opaqueObjects, transmissiveObjects, scene, camera) {
      ...
      _this.getDrawingBufferSize(_vector24);
      if (isWebGL2) {
        _transmissionRenderTarget.setSize(_vector24.x, _vector24.y);
      } else {
        _transmissionRenderTarget.setSize(floorPowerOfTwo(_vector24.x), floorPowerOfTwo(_vector24.y));
      }
...
//# sourceMappingURL=three_src_renderers_WebGL1Renderer.js.map
